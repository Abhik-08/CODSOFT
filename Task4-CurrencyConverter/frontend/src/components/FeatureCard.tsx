...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 w-full h-[260px] md:h-[300px] opacity-60 rounded-[40px] pointer-events-none transition-all duration-500 group-hover:scale-105 group-hover:opacity-80"
        style={{
          background: gradient,
          filter: 'blur(45px)',
        }}
      ...
      <div
        className="self-stretch h-[260px] md:h-[300px] rounded-[40px] z-10 overflow-hidden relative border-8 border-transparent transition-all duration-300 group-hover:scale-[1.02]"
        style={{
